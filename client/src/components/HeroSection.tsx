        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            ...
            >
              <a
                href="#services"
                className="inline-flex items-center font-[Montserrat] text-[12px] uppercase tracking-[0.15em] text-[#0A0A0A] bg-[#C9A84C] px-8 py-3.5 rounded-full hover:bg-[#E8D5B7] transition-colors duration-300"
              >
                Explore Our Services
              </a>
              <a
                href="#about"
                className="inline-flex items-center font-[Montserrat] text-[12px] uppercase tracking-[0.15em] text-[#C9A84C] border border-[#C9A84C]/40 px-8 py-3.5 rounded-full hover:border-[#C9A84C] hover:bg-[#C9A84C]/10 transition-all duration-300"
              >
                Learn More
              </a>
            </div>
